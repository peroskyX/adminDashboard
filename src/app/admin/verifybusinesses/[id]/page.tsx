...
import {
  ...
  updateBusinessVerifiedField, // New function to update the verified field
  updateBusinessVerificationOrder, // New function to update the verificationOrder field
    ...
    const fetchData = async () => {
      if (id && typeof id === 'string') {
        try {
          ...
          setError('Verification details are not uploaded yet.');
        } finally {
          setLoading(false);
        }
      } else {
